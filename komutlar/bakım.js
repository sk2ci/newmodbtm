...
exports.run = (client, message, args) => {
  ...
  if(message.author.id != "820212938761043998") return message.channel.send("```Bu komutu sadece sahibim kullana bilir görünüşe göre sen sahibim değilsin yada senmisin?!```")
