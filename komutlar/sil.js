...
if(db.fetch(`bakimmod`)) {
  ...
  if(message.author.id !== "1069869369745735781") return message.channel.send('```Şuanlık Discord Botumuz Bakımdadır Lütfen Bir Kaç Saat Sonra Tekrar Deneyiniz Veya Ellunati#4909 Bana Ulaşın```')
