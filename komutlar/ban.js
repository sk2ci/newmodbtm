...
if(db.fetch(`bakimmod`)) {
  ...
  if(message.author.id !== "820212938761043998") return message.channel.send('```Şuanlık Discord Botumuz Bakımdadır Lütfen Bir Kaç Saat Sonra Tekrar Deneyiniz Veya  Bana Ulaşın```')
